def calculate_overall_score(skill_scores):
    """
    Calculate the simple average of all skill scores.
    """
    ...
    number_of_skills = len(skill_scores)

    return round(total / number_of_skills)


def calculate_weighted_score(skill_scores, weights):
    """
    Calculate job-specific weighted competency score.
    """
    ...
    for skill, weight in weights.items():
        ...
        candidate_score = skill_scores.get(skill, 0)
